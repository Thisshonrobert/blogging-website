        ...
        <div className="relative inline-block text-left">
            <div className="absolute right-0 top-4 z-10 mt-2 w-48 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none transition-transform duration-300 transform">
                <div className="py-1">
                    ...
                    <Link to={"/yourBlogs"} className="text-gray-700 block px-4 py-2 text-sm ">Your Blogs</Link>
                        ...
                        <button onClick={()=>{
                            ...
                            navigate("/signup")
                        }} className="text-gray-700  block w-full px-4 py-2 text-left text-sm">Sign out</button>
