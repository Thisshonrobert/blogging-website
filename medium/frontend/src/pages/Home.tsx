    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow bg-amber-400">
        ...
        <div className="flex flex-col mt-20 px-24">
          <div className="font-medium font-heading text-8xl ">Stay curious.</div>
          <div className="text-2xl py-6 max-w-md">
            Discover stories, thinking, and expertise from writers on any topic.
          </div>
          <Link to={"/signup"}>
            <button
              type="button"
              className="focus:outline-none text-white bg-black focus:ring-4  font-medium rounded-full text-sm px-4 py-4 me-2 mb-2 mr-3 "
            >
              Start Reading
            </button>
          </Link>
